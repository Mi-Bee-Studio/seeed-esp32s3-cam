...
```
I (xxx) main: MiBee Cam v0.4.0 starting...
...
在手机或电脑上搜索 WiFi 名称：`MiBee Cam-XXXX`（XXXX 为 MAC 地址后 4 位十六进制），连接该网络。
...
I (xxx) main: MiBee Cam v0.4.0 initialized successfully
...
返回结果应包含：`"firmware_version": "0.4.0"`
