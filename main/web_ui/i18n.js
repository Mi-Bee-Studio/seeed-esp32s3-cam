...
(function () {
  ...
  const STRINGS = {
    en: {
      ...
      'wm.title': 'Watermark',
      'wm.hint': 'Burned into photos & recordings',
      'wm.enable': 'Enable watermark',
      'wm.video': 'Watermark video track',
      'wm.text': 'Custom text (ASCII)',
      'wm.time_fmt': 'Timestamp format (strftime)',
      'wm.pos': 'Position',
      'wm.pos_bl': 'Bottom left',
      'wm.pos_br': 'Bottom right',
      'wm.pos_tl': 'Top left',
      'wm.pos_tr': 'Top right',
      'wm.quality': 'Re-encode quality (60-95)',
    ...
    zh: {
      ...
      'wm.hint': '烧录进照片与录像',
      'wm.enable': '启用水印',
      'wm.video': '视频轨水印（重编码耗 CPU，帧率下降）',
      'wm.text': '自定义文案（ASCII）',
      'wm.time_fmt': '时间戳格式（strftime）',
      'wm.pos': '位置',
      'wm.pos_bl': '左下',
      'wm.pos_br': '右下',
      'wm.pos_tl': '左上',
      'wm.pos_tr': '右上',
      'wm.quality': '重编码质量（60-95）',
