...
/* MiBee vendoring stamp (2026-09-06): imported from main @ SDK version 3.0.0
 * (idf_component.yml) via raw.githubusercontent batch fetch — no git history,
 * hence stamped here per the bundle mechanism above. */
#define ESPECTRE_SDK_VERSION_MAJOR 3
#define ESPECTRE_SDK_VERSION_MINOR 0
#define ESPECTRE_SDK_VERSION_PATCH 0
#define ESPECTRE_SDK_VERSION_STRING "3.0.0-vendored"
